    ...
    <div className="min-w-screen min-h-screen bg-white flex items-center justify-center px-5 py-5">
      <div className="bg-gray-100 shadow-xl w-full overflow-hidden max-w-6xl">
        <div className="md:flex w-full">
          ...
          <div className="w-full md:w-2/3 py-10 px-5 md:px-10">
            <div className="text-center mb-3">
              <h1 className="text-3xl text-gray-900 -mt-3">Patient Register</h1>
            </div>
            <form onSubmit={handleSubmit}>
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-2">
              ...
              <div className="flex -mx-3">
                <div className="w-1/2 px-3 mb-2">
                  <label className="text-xs px-1 text-black">Confirm Password</label>
                  <input
                    type="password"
                    required
                    className="w-full pl-4 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
              ...
              <div className="flex -mx-3">
                <div className="w-1/3 px-3 mb-2">
                  ...
                  <select
                    ...
                    value={gender}
                    className="block appearance-none w-full pl-4 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                  >
                    <option value=""> </option>
                    <option>Male</option>
                    <option>Female</option>
              ...
              <div className="flex flex-col -mx-3">
                ...
                <div className="w-full px-3 py-3 mb-5 mt-3">
                  <button
                    type="submit"
                    className="block w-full max-w-xs mx-auto bg-blue-400 hover:bg-blue-500 focus:bg-indigo-700 text-white rounded-lg px-3 py-3"
                  >
                    REGISTER
                  </button>
                </div>
